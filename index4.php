...
<body>
		...
		<div id="map"></div>
		<div id="side" style="position:absolute; top:100px; right:3%; width :27%; height:950px;">
			...
			<div id= "MapText" style="width :500px;"></div>	
			<div id="chart_div" ></div>
			
			<div id= "Logo" style="position:absolute; bottom:0%; right:-60px; width :400px;">
	 ...
	 XMLHttp.onreadystatechange=function () {
		if(XMLHttp.readyState==4 && XMLHttp.status==200) {
			...
			if(regionalspecific == null){	
				...
				{
					 //alert('뭐지?');
					 Xaxis1 = "20대초반";Xaxis2 = "20대후반";Xaxis3 = "30대초반";Xaxis4 = "30대후반";
				}
				...
				{
					 //alert('뭐지?');
					 Xaxis1 = "주거지역";Xaxis2 = "상업지역";Xaxis3 = "공업지역";Xaxis4 = "대지";
				}
