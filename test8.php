			...
			<div id="right_div">
				...
				<div class="test1" style="float:left; margin: 0 auto; " >
					<label class="switchRED switchRED-slide">
						<input class="switchRED-input" name="category1[]" id="redbtn1" onclick='REDbtn(0,"인구");' value="인구" type="checkbox" />
						<span class="switchRED-label" data-on="인구" data-off="인구"></span> 
					</label>
				</div>
				<div class="test2" style="float:left;margin: 0 auto; ">
					<label class="switchRED switchRED-slide">
						<input class="switchRED-input" name="category1[]" id="redbtn2" onclick='REDbtn(1,"사업체");' value="사업체" type="checkbox" />
				...
				<div class="test3" style="float:left;margin: 0 auto; ">
					<label class="switchRED switchRED-slide">
						<input class="switchRED-input" name="category1[]" id="redbtn3" onclick='REDbtn(2,"토지");'value="토지" type="checkbox" />
