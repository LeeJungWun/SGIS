...
<body>
		<div id="header"><a href="http://mslsgis.dothome.co.kr/test4.php" style="margin-left:auto;margin-right:auto;"><img src="/image/타이틀.jpg" border="0"></a></div>
		<div id="map_menu" style="width :40%;float:left;">
		<div id="map"  style="height:500px; margin-left:3%; margin-right:3%"></div>
		<div class="menuSelectBar1" id="menuSelectBar1" style="width:100%;bottom:150px; margin-left:8%;">
				<form name="redZone">
				...
				<div class="test9" style="float:left;">
					<label class="switch switch-slide">
				...
				<div class="test10" style="float:left;">
					<label class="switch switch-slide">
		...
		<div id="side" style="top:100px; text-align: center; width :35%; height:950px; float:left;">
				
			<div id="" class = "elem" style="height:50px;">
				<a style="font-size: 20px;">원하는 지역 선택 :</a> 
			...
			<div id= "MapTextTitle"  style="text-align: center; font-weight: bold; font-size: 30px; height:50px;">그래프 설명</div>	
			<div id= "MapText"  style="text-align: center; margin:0 auto; width :650px;"></div>
			<div id= "chartTitle"  style="text-align: center;  margin: 8px 0px 8px 0px; font-weight: bold; font-size: 30px; height:40px;">통계 그래프</div>
			<div id="chart_div" style="text-align: center; margin:0 auto; width :80%;"></div>
			
			<div id= "Logo" style="bottom:0%; margin:0 auto; width :400px;">
	 ...
	 XMLHttp.onreadystatechange=function () {
		if(XMLHttp.readyState==4 && XMLHttp.status==200) {
			...
			if(regionalspecific == null){	
				...
				{
					 //alert('뭐지?');
					 Xaxis1 = "20대초반 인구";Xaxis2 = "20대후반 인구";Xaxis3 = "30대초반 인구";Xaxis4 = "30대후반 인구";
					 measure1 = "명";
				}
				 if(ShowData == "corp_cnt" && RedButton == "company")
				{
					 //alert('뭐지?');
					 Xaxis1 = "제조업";Xaxis2 = "도소매업";Xaxis3 = "운수업";Xaxis4 = "금융및보험";
					 measure1 = "개";
				}
				 if(ShowData == "corp_cnt" && RedButton == "ground")
				{
					 //alert('뭐지?');
					 Xaxis1 = "주거지역 거래";Xaxis2 = "상업지역 거래";Xaxis3 = "공업지역 거래";Xaxis4 = "대지 거래";
					 measure1 = "건";
				}
			
				 switch(BlueButton1){
				 	case "sgis_school" :
				 		Xaxis5 = "고등학생수"; Xaxis6 ="진학자수"; Xaxis7 ="입학자수";
				 		measure2 = "명";
				 		break;
				 	case "sgis_car" :
				 		Xaxis5 = "속도위반"; Xaxis6 ="신호위반"; Xaxis7 ="안전띠미착용";
				 		measure2 = "건";
				 		break;
				 	...
				 	case "sgis_pension" :
				 		...
				 		break;
				 	case "sgis_limited" :
				 		Xaxis5 = "가구수"; Xaxis6 ="인구수"; Xaxis7 ="건축물수";
				 		break;
				 	case "sgis_commute" :
				 		Xaxis5 = "거주하는 동으로 통근"; Xaxis6 ="같은 시군구 다른 동으로 통근"; Xaxis7 ="다른 시군구으로 통근";
				 		measure2 = "명";
				 		break;
				 }
				 ...
				 switch(BlueButton2){
				 	case "sgis_school" :
				 		Xaxis8 = "고등학생수"; Xaxis9 ="진학자수"; Xaxis10 ="입학자수";
				 		measure3 = "명";
				 		break;
				 	case "sgis_car" :
				 		Xaxis8 = "속도위반"; Xaxis9 ="신호위반"; Xaxis10 ="안전띠미착용";
				 		measure3 = "건";
				 		break;
				 	case "sgis_practician" :
				 	...
				 	case "sgis_pension" :
				 		...
				 		break;
				 	case "sgis_limited" :
				 		Xaxis8 = "가구수"; Xaxis9 ="인구수"; Xaxis10 ="건축물수";
				 		break;
				 	case "sgis_commute" :
				 		Xaxis8 = "거주하는 동으로 통근"; Xaxis9 ="같은 시군구 다른 동으로 통근"; Xaxis10 ="다른 시군구 동으로 통근";
				 		measure3 = "명";
				 		break;
			}
			   ...
			   switch(Lowitem3){
				...
				if(BlueCount == 0){		//그래프만 나오는 파란버튼 클릭 수 확인
					   ...
					   document.getElementById("MapText").innerHTML = "현재 선택된 지역은<font size=5>"+DB_name+"</font>입니다.<br>가장 높은 통계 : <font size=5>"+TopTitle1+"</font>(<font size=5>"+Topitem1+measure1+"</font>)<br>가장 낮은 통계 : <font size=5>"+LowTitle1+"</font>(<font size=5>"+Lowitem1+measure1+"</font>)</font>";
				}
				...
				if(BlueCount == 1){		//그래프만 나오는 파란버튼 클릭 수 확인
				   ...
				   if(BlueButton1 == "sgis_limited"){
				   	document.getElementById("MapText").innerHTML = "현재 선택된 지역은 <font size=5>"+DB_name+"</font>입니다.<br>가장 높은 통계 : <font size=5>"+TopTitle1+"</font>(<font size=5>"+Topitem1+measure1+"</font>),<font size=5>"+TopTitle2+"</font>(<font size=5>"+Topitem2+"명</font>)<br>가장 낮은 통계 : <font size=5>"+LowTitle1+"</font>(<font size=5>"+Lowitem1+measure1+"</font>),<font size=5>"+LowTitle2+"</font>(<font size=5>"+Lowitem2+"가구</font>)</font>";
				   }
				   else{
				   	document.getElementById("MapText").innerHTML = "현재 선택된 지역은 <font size=5>"+DB_name+"</font>입니다.<br>가장 높은 통계 : <font size=5>"+TopTitle1+"</font>(<font size=5>"+Topitem1+measure1+"</font>),<font size=5>"+TopTitle2+"</font>(<font size=5>"+Topitem2+measure2+"</font>)<br>가장 낮은 통계 : <font size=5>"+LowTitle1+"</font>(<font size=5>"+Lowitem1+measure1+"</font>),<font size=5>"+LowTitle2+"</font>(<font size=5>"+Lowitem2+measure2+"</font>)</font>";
				   }
				}
				...
				if(BlueCount == 2){		//그래프만 나오는 파란버튼 클릭 수 확인
					   ...
					   if(BlueButton1 == "sgis_limited"){
						   document.getElementById("MapText").innerHTML = "현재 선택된 지역은 <font size=5>"+DB_name+"</font>입니다.<br>가장 높은 통계 : <font size=5>"+TopTitle1+"</font>(<font size=5>"+Topitem1+measure1+"</font>),<font size=5>"+TopTitle2+"</font>(<font size=5>"+Topitem2+"명</font>),<font size=5>"+TopTitle3+"</font>(<font size=5>"+Topitem3+measure3+"</font>)<br>가장 낮은 통계 : <font size=5>"+LowTitle1+"</font>(<font size=5>"+Lowitem1+measure1+"</font>),<font size=5>"+LowTitle2+"</font>(<font size=5>"+Lowitem2+"가구</font>),<font size=5>"+LowTitle3+"</font>(<font size=5>"+Lowitem3+measure3+"</font>)</font>";
					   }
					   else if(BlueButton2 == "sgis_limited"){
						   document.getElementById("MapText").innerHTML = "현재 선택된 지역은 <font size=5>"+DB_name+"</font>입니다.<br>가장 높은 통계 : <font size=5>"+TopTitle1+"</font>(<font size=5>"+Topitem1+measure1+"</font>),<font size=5>"+TopTitle2+"</font>(<font size=5>"+Topitem2+measure2+"</font>),<font size=5>"+TopTitle3+"</font>(<font size=5>"+Topitem3+"명</font>)<br>가장 낮은 통계 : <font size=5>"+LowTitle1+"</font>(<font size=5>"+Lowitem1+measure1+"</font>),<font size=5>"+LowTitle2+"</font>(<font size=5>"+Lowitem2+measure2+"</font>),<font size=5>"+LowTitle3+"</font>(<font size=5>"+Lowitem3+"명</font>)</font>";
					   	}
					   else{
						   document.getElementById("MapText").innerHTML = "현재 선택된 지역은 <font size=5>"+DB_name+"</font>입니다.<br>가장 높은 통계 : <font size=5>"+TopTitle1+"</font>(<font size=5>"+Topitem1+measure1+"</font>),<font size=5>"+TopTitle2+"</font>(<font size=5>"+Topitem2+measure2+"</font>),<font size=5>"+TopTitle3+"</font>(<font size=5>"+Topitem3+measure3+"</font>)<br>가장 낮은 통계 : <font size=5>"+LowTitle1+"</font>(<font size=5>"+Lowitem1+measure1+"</font>),<font size=5>"+LowTitle2+"</font>(<font size=5>"+Lowitem2+measure2+"</font>),<font size=5>"+LowTitle3+"</font>(<font size=5>"+Lowitem3+measure3+"</font>)</font>";
					   }
				}
			}
			//*************************************************************************//
