...
//  $q2 = $_POST['ans2'];	//질문의 대한 버튼 값
   ...
   //xhr.send("line=" + line+ ",station=" + bustation + ",ans1="+q1);
	...
	//initialize();
		...
		document.all("infowin").innerHTML="여기에 그래프에 대한 소스를 넣어주어야 합니다.";
	// Create the data table.
        ...
        var node1        = document.createElement('div'), // chart1 div
            ...
            chart2       = new google.visualization.PieChart(node1),
            chart       = new google.visualization.PieChart(node2);
            
			allnode.appendChild(node1);
			allnode.appendChild(node2);

            chart.draw(data, {'title':'13-1 침산동이마트앞, 나. 통학버스 정거장의 위치는 적절한가?',
                       'width':400,
                       'height':150});

			chart2.draw(data2, {'title':'13-1 침산동이마트앞, 가. 통학버스 정거장의 배차시간은 적절한가?',
                       'width':400,
                       'height':150});
